...
def test_random_logit_torch_fnet_model(torch_fnet, sst2_dataset, init_kwargs, call_kwargs):
    metric = RandomLogit(**init_kwargs)
...
def test_model_parameter_randomisation_tf_model(tf_sst2_model, sst2_dataset, init_kwargs, call_kwargs):
...
def test_model_parameter_randomisation_torch_emotion_model(emotion_model, emotion_dataset, init_kwargs, call_kwargs):
    metric = ModelParameterRandomisation(**init_kwargs)
