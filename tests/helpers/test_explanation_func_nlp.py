...
@pytest.mark.parametrize(
    ...
    [
        ...
        {
            "method": "NoiseGrad",
            "config": transformers_gradients.NoiseGradConfig(
                n=2, explain_fn="GradXInput"
            ),
        },
        {
            "method": "NoiseGrad++",
            "config": transformers_gradients.NoiseGradPlusPlusConfig(
                n=2, m=2, explain_fn="GradXInput"
            ),
        },
        {"method": "LIME", "config": transformers_gradients.LimeConfig(num_samples=5)},
...
@pytest.mark.parametrize(
    ...
    [
        ...
        {"method": "IntGrad"},
        {
            ...
            "config": noisegrad.NoiseGradConfig(n=2),
        },
        {
            "method": "NoiseGrad++",
            "explain_fn": "GradXInput",
            "config": noisegrad.NoiseGradPlusPlusConfig(n=2, m=2),
        },
