...
from quantus.helpers.typing_utils import Explanation, TextClassifier
...
class MPRT(Metric):
    ...
    def _(
        ...
        # Extract scores from NLP explanations.
        a = get_scores(a)
        a_perturbed = get_scores(a_perturbed)
        return self.similarity_func(np.reshape(a_perturbed, -1), np.reshape(a, -1))
