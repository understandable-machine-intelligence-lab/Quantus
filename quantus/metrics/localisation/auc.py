...
class AUC(Metric):
    ...
    def custom_preprocess(
        ...
        Parameters
        ----------
            model (Union[torch.nn.Modules, tf.keras.Model]): A torch or tensorflow model e.g., torchvision.models that is subject to explanation.
            ...
            s_batch (np.ndarray): A Union[np.ndarray, None] which contains segmentation masks that matches the input.
