...
class TensorFlowModel(ModelInterface):
    ...
    def get_randomizable_layer_names(self, order: str = "top_down"):
        """
        ...
        """
        layer_names = [_layer.name for _layer in self.model.layers if len(_layer.get_weights()) > 0]
        if order == "top_down":
    ...
    def get_random_model_until_layer(self, order: str = "top_down", seed: int = None, layer_name: str = ""):
        """
        ...
        order: string
            The various ways that a model's weights of a layer can be randomised.
        seed: integer
            The seed of the random layer generator. Set to none to not set a manual seed.
        layer_name: string
        ...
        return layer.name, random_layer_model
