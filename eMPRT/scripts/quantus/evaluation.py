        ...
        for (metric, metric_func) in metrics.items():
            ...
            for (call_kwarg_str, call_kwarg) in call_kwargs.items():
                ...
                if attributions_path is not None:
                    specific_attributions_path = os.path.join(attributions_path, metric, method)
                    if os.path.exists(specific_attributions_path):
                        shutil.rmtree(specific_attributions_path)
                    os.makedirs(specific_attributions_path, exist_ok=True)
                else:
                    specific_attributions_path = None
                ...
                results[method][metric][call_kwarg_str] = agg_func(
                    metric_func(
                        ...
                        attributions_path = specific_attributions_path,
                        **call_kwarg,
                        **kwargs,
                    )
                )
