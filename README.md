...
* **Localisation:** test if the explainable evidence is centered around the object of interest (as defined by a bounding box)
...
* **Axiomatic:** assess if explanations fulfill certain axiomatic properties
